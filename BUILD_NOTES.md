...
| `projects` | `userId` | `name, domain, tech_stack[], description, intake{backup{have,platform,acknowledged}, goals{summary,categories[],pages[]}, connection{serverId}, completedAt}, siteNotes, changeLog[{summary,requestId,model,at}], created_at, updated_at` |
